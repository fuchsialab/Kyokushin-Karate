...
public class yellowadapter extends FirebaseRecyclerAdapter <yellowmodel, yellowadapter.myviewholder>{

    public yellowadapter(FirebaseRecyclerOptions<yellowmodel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull final yellowmodel model) {
