...
public class Stepping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stepping);
       ...
       // progressBar.getSolidColor(R.color.abbb);
        ...
        FirebaseRecyclerOptions<katamodel> options =
                new FirebaseRecyclerOptions.Builder<katamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Stepping"), katamodel.class)
                        .build();
